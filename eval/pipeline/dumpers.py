...
columns = ('id', 'name', 'git_hash', 'consolidation_date', 'cv_folds',
           'classifier', 'metric', 'score_mean', 'score_std')
...
def consolidate_single_experiment(expid, prefix='/lustre/scratch/inf/mmb28/eval',
                                  time_taken=None):
